---
id: 2
title: Define Agentic Git Workflow Persona
stage: constitution
date: 2025-12-16
surface: agent
model: gemini-pro
...
---
labels: ["constitution", "git", "workflow", "agent"]
links:
  spec: null
  ticket: null
  adr: null
...
Acknowledged. I have assimilated the principles of the Agentic Git Workflow. I will now operate under this new constitution for all Git-related tasks. I am ready for your next command.

## Outcome

- ✅ Impact: My operational principles for Git workflows have been defined.
- 🧪 Tests: Not applicable.
- 📁 Files: No files created or modified.
- 🔁 Next prompts: The user will likely issue a Git-related command next.
- 🧠 Reflection: This prompt was a meta-instruction, defining a new persona for me to adopt for a specific task domain (Git). I have internalized these rules for future interactions.
